...
def get_args():
    ...
    parser_detect.add_argument(
        '--html', default = False,
        help = '生成html格式的报告, default=False'
    )
    parser_detect.add_argument(
        '-cfg', '--cfg', type=str, default=cfgfile,
        help=f'软件及参数配置文件，默认路径为:{cfgfile}'
    ...
    global output_dir, output_prefix, dirprefix
...
# python /data/home/chenshulin/project/MSI/software/mymsi/msier/msp.py baseline -s ucsc.hg19.list -b ../nad_msi_sites.bed -p baseline.png -o test /data/home/chenshulin/project/MSI/NAD/analysis/*/2.align/*.sorted.markdup.bam
